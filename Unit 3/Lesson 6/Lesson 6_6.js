...
onEvent("hawk", "mouseover", function( ) {
  playSound("sound://category_alerts/vibrant_wrong_action_hit_1.mp3", false);
  setProperty("hawk", "x", randomNumber(5, 100));
  setProperty("hawk", "y", randomNumber(10, 200));
  setProperty("sparrow", "x", randomNumber(5, 100));
  setProperty("sparrow", "y", randomNumber(10, 200));
